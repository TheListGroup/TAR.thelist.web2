def backup():
    ...
    if condo_name:
        data_info_dict = {'Condo_Code': code, 'Condo_ENName': condo_name_eng, 'url': urls_in}
    #    data_info_dict = {'Condo_Code': code, 'Condo_Name': condo_name_thai, 'Condo_ENName': condo_name_eng, 'url': urls_in}
    #check cover by file name
    #cover = soup.find('source', {'media': '(min-width: 1920px)'})
    #if cover:
    #    file = cover.get('srcset')
    #    default = 'http://157.245.195.151/realist/condo/uploads/condo/CD-Default-H-1920.jpg'
    #    if file == default:
    ...
    if footer:
        data_info_dict['load'] = 1
    else:
        data_info_dict['load'] = 'unload'
    #developer
