...
csv_path = r"C:\Users\RealResearcher1\Documents\GitHub\TAR.thelist.web2\propertyhub\match2.csv"
...
if log:
    query = """INSERT INTO realist_log (Type, SQL_State, Message, Location)
            VALUES (%s, %s, %s, %s)"""
    val = (0, '00000', f'Insert_Match {m} Rows and Insert_Not_Match {n} Rows', f'{agent}_Insert_Project_After_Manual')
    try:
