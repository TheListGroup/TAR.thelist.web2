...
scrap_data = pd.read_csv(r"C:\Users\RealResearcher1\Documents\GitHub\TAR.thelist.web2\propertyhub\condo_link2.csv", encoding='utf-8')
file_name = r"C:\Users\RealResearcher1\Documents\GitHub\TAR.thelist.web2\propertyhub\match2.csv"
...
if sql:
    ...
    query = """select Ref_ID
                ...
                from (select cp.Ref_ID
                        ...
                        left join (select Project_ID from classified_match where Agent = "PropertyHub") m on cp.Project_ID = m.Project_ID
                        left join (select Project_ID from classified_not_match where Agent = "PropertyHub") n on cp.Project_ID = n.Project_ID) c
