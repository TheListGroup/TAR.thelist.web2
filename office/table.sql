...
CREATE TABLE IF NOT EXISTS office_building (
    ...
    AC_System ENUM( 'Split Type', 'Water Cooled Chiller', 'Central Chilled Water VAV', 'Water Cooled Package + Split Type', 'Water Cooled Package', 'Magnatic Cooling Chiller', 'Central Chilled Water', 'Central Chilled Water + Split Type', 'Cooling Tower', 'Central Air', 'Variable Air Volume', 'Split Type + VRV', 'Chiller System', 'VRV', 'Water Cooled Chiller + Split Type', 'Air Cooled Package', 'Air Cooled Package + Split Type', 'Central Chiller Water', 'Air Cooled Package VRV', 'Central Chiller Water VAV', 'Central Chiller Water AHU', 'Central Chiller Water VRV', 'VAV', 'Cooling Tower + VAV') NULL,
    ACTime_Start TIME NULL,
    ACTime_End TIME NULL,
    AC_OT_Weekday_by_Hour FLOAT NULL,
    AC_OT_Weekday_by_Area FLOAT NULL,
