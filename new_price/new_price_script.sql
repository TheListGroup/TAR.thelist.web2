...
where Data_Status = 1
and Data_Attribute in ('price_per_unit_mb','price_per_sqm')
and Data_Note in ('พี่บีม Official','พี่บีมส่งข้อมูลมาให้ google drive','พี่ตอบอก : มีอัพเดตข้อมูลมา');
...
delete from real_condo_561 where Data_Note in ('พี่บีม Official','พี่บีมส่งข้อมูลมาให้ google drive','พี่ตอบอก : มีอัพเดตข้อมูลมา','ตตบอก') and Data_Attribute in ('price_per_unit_mb','price_per_sqm');