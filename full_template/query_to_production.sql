...
CHANGE `Size` `Size` FLOAT(8,3) UNSIGNED NULL DEFAULT NULL;
...
order by U1.Condo_Code, U1.Unit_Type_ID;
...
order by main.Condo_Code, main.Room_Type_ID, main.Size;
...
BEGIN
    ...
    -- Declare the cursor for the view
    DECLARE cur CURSOR FOR SELECT * FROM source_full_template_unit_plan_fullscreen_view;
    -- more columns here as needed
...
BEGIN
    ...
    -- Declare the cursor for the view
    DECLARE cur CURSOR FOR SELECT * FROM source_full_template_unit_gallery_fullscreen_view;
    -- more columns here as needed
...
BEGIN
    ...
    -- Declare the cursor for the view
    DECLARE cur CURSOR FOR SELECT * FROM source_full_template_floor_plan_fullscreen_view;
    -- more columns here as needed
...
BEGIN
    ...
    -- Declare the cursor for the view
    DECLARE cur CURSOR FOR SELECT * FROM source_full_template_facilities_gallery_fullscreen_view;
    -- more columns here as needed
