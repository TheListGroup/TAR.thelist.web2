...
#save_folder = r"C:\PYTHON\TAR.thelist.web2\classifield\ERA\classified_image"
save_folder = "/var/www/html/realist/condo/uploads/classified"
#json_file = r"C:\PYTHON\TAR.thelist.web2\classifield\ERA\era.json"
#json_file = r"/home/gitdev/ta_python/classifield/ERA/era.json"
json_file = r"/home/gitprod/ta_python/classifield/ERA/era.json"
...
sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1cw22S-MOecJVTfLDt8svBEzlJ6jZ46UaW_4FVfxEW8c/edit#gid=0')
file_id = sheet.id
        ...
        if file_id_match:
            ...
            try:
                ...
                try:
                    ...
                    print(f'Error: {e} at ERA_insert_prop_Image')
                    insert_log("ERA_insert_prop_Image")
                    break
            except:
                pass
    ...
    if response.status_code == 200:
        ...
        for data in data_list:
            ...
            try:
                ...
                stop_processing = True
                print(f'Error: {e} at ERA_check_column')
                log = False
                insert_log("ERA_check_column")
                break
            ...
            if found:
                ...
                try:
                    ...
                    stop_processing = True
                    print(f'Error: {e} at ERA_insert_prop_Update')
                    log = False
                    insert_log("ERA_insert_prop_Update")
                    break
                ...
                try:
                    ...
                    log = False
                    insert_log("ERA_insert_prop_Insert")
                    break
        
        if log:
            insert_log("ERA_insert_prop")
