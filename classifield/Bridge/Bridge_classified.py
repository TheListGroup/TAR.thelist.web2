...
#json_file = r"C:\PYTHON\TAR.thelist.web2\classifield\Bridge\bridge.json"
#json_file = r"/home/gitdev/ta_python/classifield/Bridge/bridge.json"
json_file = r"/home/gitprod/ta_python/classifield/Bridge/bridge.json"
...
sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1_ig3t4I-hX8UwJPzAHDLOKqplpU2ekhk3cFrT6BtzdI/edit#gid=0')
file_id = sheet.id
        ...
        if file_id_match:
            ...
            try:
                ...
                try:
                    ...
                    print(f'Error: {e} at BRIDGE_insert_prop_Image')
                    insert_log("BRIDGE_insert_prop_Image")
                    break
            except:
                pass
        ...
        for data in data_list:
            ...
            if data[5] == 'Condo':
                ...
                try:
                    ...
                    stop_processing = True
                    print(f'Error: {e} at BRIDGE_check_column')
                    log = False
                    insert_log("BRIDGE_check_column")
                    break
                ...
                if found:
                    ...
                    try:
                        ...
                        stop_processing = True
                        print(f'Error: {e} at BRIDGE_insert_prop_Update')
                        log = False
                        insert_log("BRIDGE_insert_prop_Update")
                        break
                    ...
                    try:
                        ...
                        log = False
                        insert_log("BRIDGE_insert_prop_Insert")
                        break
        
        if log:
            insert_log("BRIDGE_insert_prop")
