...
CREATE TABLE IF NOT EXISTS `classified` (
    ...
    `Room_Type` ENUM('Studio','1 Bedroom','2 Bedroom','3 Bedroom','4 Bedroom','4+ Bedrooms') NULL,
...
CREATE TABLE IF NOT EXISTS `classified_all_logs` (
    ...
    `Type` ENUM('update','insert','error','status') NOT NULL,
    `Classified_ID` INT UNSIGNED NULL,
    ...
    `Condo_Code` VARCHAR(50) NOT NULL,
    `Sale` BOOLEAN NOT NULL DEFAULT 0,
    `Sale_with_Tenant` BOOLEAN NULL DEFAULT 0,
    `Rent` BOOLEAN NOT NULL DEFAULT 0,
    `Price_Sale` INT UNSIGNED NULL,
    `Sale_Transfer_Fee` FLOAT(6,2) UNSIGNED NULL,
    `Sale_Deposit` FLOAT(6,2) UNSIGNED NULL,
    `Sale_Mortgage_Costs` FLOAT(6,2) UNSIGNED NULL,
    `Price_Rent` INT UNSIGNED NULL,
    ...
    `Room_Type` ENUM('Studio','1 Bedroom','2 Bedrooms','3 Bedrooms','4 Bedrooms','4+ Bedrooms') NULL,
