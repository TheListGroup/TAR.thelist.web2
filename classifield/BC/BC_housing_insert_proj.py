...
#csv_path = r"C:\Users\RealResearcher1\Documents\GitHub\TAR.thelist.web2\classifield\BC\BC_housing_Match.csv"
#csv_path = '/home/gitdev/ta_python/classifield/BC/BC_housing_Match.csv'
csv_path = '/home/gitprod/ta_python/classifield/BC/BC_housing_Match.csv'
...
if len(match_list) > 0:
    ...
    try:
        ...
        print(f'Error: {e} at Insert_Housing_Match')
...
if len(not_match_list) > 0:
    ...
    try:
        ...
        print(f'Error: {e} at Insert_Not_Housing_Match')

if log:
    query = """INSERT INTO realist_log (Type, SQL_State, Message, Location)
            VALUES (%s, %s, %s, %s)"""
    val = (0, '00000', f'Insert_Housing_Match {m} Rows and Insert_Not_Housing_Match {n} Rows', 'BC_Insert_Housing_After_Manual')
    try:
